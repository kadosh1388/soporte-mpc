...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "Estado"),
        ("Your Desktop", "Asistencia Remota"),
        ("desk_tip", "Facilite este ID y contraseña al técnico de MPC Empresas."),
        ("Password", "Contraseña"),
        ("Ready", "Listo"),
        ("Established", "Establecido"),
        ("connecting_status", "Conectando con el servidor de MPC Empresas..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que RemotoMPC no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar RemotoMPC a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a RemotoMPC de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a RemotoMPC de \"Grabación de pantalla\"."),
        ...
        ("powered_by_me", "Soporte Oficial MPC Empresas"),
        ...
        ("About RustDesk", "Acerca de MPC Empresas"),
